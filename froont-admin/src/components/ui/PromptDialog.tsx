      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-[#409eff] resize-y text-sm"
          />
        </div>
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            disabled={!canConfirm}
            className="px-4 py-2 text-sm text-white bg-[#409eff] hover:bg-[#66b1ff] rounded disabled:opacity-50 transition-colors"
          >
