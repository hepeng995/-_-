...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<ProductDTO> listProductDTO(Integer delete, Integer status) {
        ...
        // 2. 批量查询分类
        List<ProductCategory> productCategories = categoryMapper.selectBatchIds(categoryIds);

        // 3. 转成Map
        Map<Long, String> categoryNameMap = productCategories.stream()
